...
layout = dbc.Container([
    dcc.Store(id="user-initialized", storage_type="local"),
    dcc.Location(id='url', refresh=False),
    dcc.Location(id='init-user', href='/init_user', refresh=True),
    ...
    dcc.Store(id="file-type", data='csv'),
